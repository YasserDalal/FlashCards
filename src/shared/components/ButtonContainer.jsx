  ...
  return (
    <div className="h-[10%]">
      <div className="flex rounded-lg justify-between items-center bg-slate-600 h-full px-3">
        <div className={`flex ${colorPrev && "text-slate-400"} cursor-pointer`} onClick={() => previousButton(setNext, counter, setCounter, smooth, setSmooth, questionsAndAnswers, setProgress, itemOrder, setItemOrder)}>
        ...
        <div className={`flex ${colorNext && "text-slate-400"} cursor-pointer`} onClick={() => nextButton(setNext, counter, setCounter, questionsAndAnswers, smooth, setSmooth, setProgress, itemOrder, setItemOrder)}>
          <div>Next</div>
